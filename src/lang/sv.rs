...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Control Remote Desktop", "Anslut till fjärrskrivbord"),
        ...
        ("Create start menu shortcuts", "Skapa genväg på startmenyn"),
        ...
        ("Wayland requires higher version of linux distro. Please try X11 desktop or change your OS.", "Wayland kräver en högre version av Linux. Testa med X11 eller byt OS."),
        ("JumpLink", "JumpLink"),
        ...
        ("Display", ""),
        ("Default View Style", "Standardvärde för vy"),
        ("Default Scroll Style", "Standardvärde för scrollning"),
        ("Default Image Quality", "Standardvärde för bildkvalitet"),
        ("Default Codec", "Standardvärde för codec"),
        ("Bitrate", ""),
        ("FPS", ""),
        ("Auto", ""),
        ("Other Default Options", "Övriga standardvärden"),
        ("Voice call", "Röstsamtal"),
        ("Text chat", "Textchatt"),
        ("Stop voice call", "Avsluta röstsamtal"),
        ("relay_hint_tip", ""),
        ("Reconnect", "Återanslut"),
        ("Codec", ""),
        ("Resolution", "Upplösning"),
        ("No transfers in progress", "Inga pågående filöverföringar"),
        ("Set one-time password length", "Ställ in längd för engångslösenord"),
        ...
        ("Stop", ""),
        ("exceed_max_devices", ""),
        ("Sync with recent sessions", "Synronisera med senaste sessionerna"),
        ...
        ("Can not be empty", "Kan inte vara blank"),
        ("Already exists", "Existerar redan"),
        ("Change Password", "Ändra lösenord"),
        ("Refresh Password", "Slumpa nytt lösenord"),
        ("ID", ""),
        ("Grid View", "Rutnätsvy"),
        ("List View", "List-vy"),
        ("Select", "Markera"),
